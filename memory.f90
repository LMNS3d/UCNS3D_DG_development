...
! 	    ALLOCATE (ILOCAL_RECON3(I)%INVMAT(M,IDEG,IDEG));ILOCAL_RECON3(I)%INVMAT(:,:,:)=0.0D0
		...
		allocate (ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_HIHGORDER(9,9,1));ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_HIHGORDER(:,:,:)=0.0d0 
		allocate (ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_loworder(2,3,1));ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_loworder(:,:,:)=0.0d0 

		allocate (ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_rightpoly(6,6,1));ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_rightpoly(:,:,:)=0.0d0 
	    allocate (ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_project(5,9,1));ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_project(:,:,:)=0.0d0 
		allocate (ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_projectinv(5,5,1));ILOCAL_RECON3(I)%invmat_stencilt_DG_HUANG_projectinv(:,:,:)=0.0d0 
