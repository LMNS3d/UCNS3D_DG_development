...
TYPE LOCAL_RECON3
	...
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::invmat_stencilt_DG_HUANG_HIHGORDER
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::invmat_stencilt_DG_HUANG_loworder
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::invmat_stencilt_DG_HUANG_rightpoly
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::invmat_stencilt_DG_HUANG_project
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::invmat_stencilt_DG_HUANG_projectinv
...
TYPE EXCHANGE_SOLHI
	...
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::SOL_huang	!huang
	REAL,ALLOCATABLE,DIMENSION(:,:)::vol_huang
	REAL,ALLOCATABLE,DIMENSION(:,:)::CORD_huang	!huang	
...
TYPE EXCHANGE_BOUNDHI    
	...
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::FACESOL_DG_huang	!huang
	REAL,ALLOCATABLE,DIMENSION(:,:)::CORD_huang	!huang
...
TYPE::SOLEXCHANGE
	...
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::SOL_huang	! huang
	REAL,ALLOCATABLE,DIMENSION(:,:)::vol_huang
	REAL,ALLOCATABLE,DIMENSION(:,:)::CORD_huang
...
TYPE::ELEMENT_NUMBER
	...
	integer::itotalpoints,TROUBLED,TROUBLED_HUANG !modified by huang
