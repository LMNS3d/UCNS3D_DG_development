...
FUNCTION QUADRATURETRIANGLE_huang_weight(N,IGQRULES)
	!> @brief
	!> This subroutine computes the quadrature points and weights for triangle in 2D
	IMPLICIT NONE
	INTEGER,INTENT(IN)::IGQRULES,N
	INTEGER::Kk
	REAL,dimension(qp_triangle)::QUADRATURETRIANGLE_huang_weight
	REAL,dimension(36)::vvwg_huang,VVR1_huang,VVR2_huang,VVR3_huang
	WEQUA3D=0.0d0
	QPOINTS=0.0d0
	...
	select case(IGQRULES)
		...
		case(7,8,9)
			...
			VVR1_huang(1)=0.957657154441070
			VVR1_huang(2)=0.021171422779465
			VVR1_huang(3)=0.021171422779465
			VVR1_huang(4)=0.798831205208225
			VVR1_huang(5)=0.100584397395888
			VVR1_huang(6)=0.100584397395888
			VVR1_huang(7)=0.457923384576135
			VVR1_huang(8)=0.271038307711932
			VVR1_huang(9)=0.271038307711932
			VVR1_huang(10)=0.440191258403832
			VVR1_huang(11)=0.440191258403832
			VVR1_huang(12)=0.119617483192335
			VVR1_huang(13)=0.101763679498021
			VVR1_huang(14)=0.101763679498021
			VVR1_huang(15)=0.018256679074748
			VVR1_huang(16)=0.879979641427232
			VVR1_huang(17)=0.879979641427232
			VVR1_huang(18)=0.018256679074748
			VVR1_huang(19)=0.394033271669987
			VVR1_huang(20)=0.394033271669987
			VVR1_huang(21)=0.023404705466341
			VVR1_huang(22)=0.582562022863673
			VVR1_huang(23)=0.582562022863673
			VVR1_huang(24)=0.023404705466341
			VVR1_huang(25)=0.226245530909229
			VVR1_huang(26)=0.226245530909229
			VVR1_huang(27)=0.022223854547989
			VVR1_huang(28)=0.751530614542782
			VVR1_huang(29)=0.751530614542782
			VVR1_huang(30)=0.022223854547989
			VVR1_huang(31)=0.635737183263105
			VVR1_huang(32)=0.635737183263105
			VVR1_huang(33)=0.115183589115563
			VVR1_huang(34)=0.249079227621332
			VVR1_huang(35)=0.249079227621332
			VVR1_huang(36)=0.115183589115563
	
	
	
			VVR2_huang(1)=0.021171422779465
			VVR2_huang(2)=0.957657154441070
			VVR2_huang(3)=0.021171422779465
			VVR2_huang(4)=0.100584397395888
			VVR2_huang(5)=0.798831205208225
			VVR2_huang(6)=0.100584397395888
			VVR2_huang(7)=0.271038307711932
			VVR2_huang(8)=0.457923384576135
			VVR2_huang(9)=0.271038307711932
			VVR2_huang(10)=0.440191258403832
			VVR2_huang(11)=0.119617483192335
			VVR2_huang(12)=0.440191258403832
			VVR2_huang(13)=0.879979641427232
			VVR2_huang(14)=0.018256679074748
			VVR2_huang(15)=0.101763679498021
			VVR2_huang(16)=0.101763679498021
			VVR2_huang(17)=0.018256679074748
			VVR2_huang(18)=0.879979641427232
			VVR2_huang(19)=0.582562022863673
			VVR2_huang(20)=0.023404705466341
			VVR2_huang(21)=0.394033271669987
			VVR2_huang(22)=0.394033271669987
			VVR2_huang(23)=0.023404705466341
			VVR2_huang(24)=0.582562022863673
			VVR2_huang(25)=0.751530614542782
			VVR2_huang(26)=0.022223854547989
			VVR2_huang(27)=0.226245530909229
			VVR2_huang(28)=0.226245530909229
			VVR2_huang(29)=0.022223854547989
			VVR2_huang(30)=0.751530614542782
			VVR2_huang(31)=0.249079227621332
			VVR2_huang(32)=0.115183589115563
			VVR2_huang(33)=0.635737183263105
			VVR2_huang(34)=0.635737183263105
			VVR2_huang(35)=0.115183589115563
			VVR2_huang(36)=0.249079227621332
	
	
	
	
			VVR3_huang(1)=0.021171422779465
			VVR3_huang(2)=0.021171422779465
			VVR3_huang(3)=0.957657154441070
			VVR3_huang(4)=0.100584397395888
			VVR3_huang(5)=0.100584397395888
			VVR3_huang(6)=0.798831205208225
			VVR3_huang(7)=0.271038307711932
			VVR3_huang(8)=0.271038307711932
			VVR3_huang(9)=0.457923384576135
			VVR3_huang(10)=0.119617483192335
			VVR3_huang(11)=0.440191258403832
			VVR3_huang(12)=0.440191258403832
			VVR3_huang(13)=0.018256679074748
			VVR3_huang(14)=0.879979641427232
			VVR3_huang(15)=0.879979641427232
			VVR3_huang(16)=0.018256679074748
			VVR3_huang(17)=0.101763679498021
			VVR3_huang(18)=0.101763679498021
			VVR3_huang(19)=0.023404705466341
			VVR3_huang(20)=0.582562022863673
			VVR3_huang(21)=0.582562022863673
			VVR3_huang(22)=0.023404705466341
			VVR3_huang(23)=0.394033271669987
			VVR3_huang(24)=0.394033271669987
			VVR3_huang(25)=0.022223854547989
			VVR3_huang(26)=0.751530614542782
			VVR3_huang(27)=0.751530614542782
			VVR3_huang(28)=0.022223854547989
			VVR3_huang(29)=0.226245530909229
			VVR3_huang(30)=0.226245530909229
			VVR3_huang(31)=0.115183589115563
			VVR3_huang(32)=0.249079227621332
			VVR3_huang(33)=0.249079227621332
			VVR3_huang(34)=0.115183589115563
			VVR3_huang(35)=0.635737183263105
			VVR3_huang(36)=0.635737183263105
	
	
	
			vvwg_huang(1)=0.005639123786910
			vvwg_huang(2)=0.005639123786910
			vvwg_huang(3)=0.005639123786910
			vvwg_huang(4)=0.027148968192278
			vvwg_huang(5)=0.027148968192278
			vvwg_huang(6)=0.027148968192278
			vvwg_huang(7)=0.063100912533359
			vvwg_huang(8)=0.063100912533359
			vvwg_huang(9)=0.063100912533359
			vvwg_huang(10)=0.051752795679899
			vvwg_huang(11)=0.051752795679899
			vvwg_huang(12)=0.051752795679899
			vvwg_huang(13)=0.009866753574646
			vvwg_huang(14)=0.009866753574646
			vvwg_huang(15)=0.009866753574646
			vvwg_huang(16)=0.009866753574646
			vvwg_huang(17)=0.009866753574646
			vvwg_huang(18)=0.009866753574646
			vvwg_huang(19)=0.022008204800147
			vvwg_huang(20)=0.022008204800147
			vvwg_huang(21)=0.022008204800147
			vvwg_huang(22)=0.022008204800147
			vvwg_huang(23)=0.022008204800147
			vvwg_huang(24)=0.022008204800147
			vvwg_huang(25)=0.016644570076736
			vvwg_huang(26)=0.016644570076736
			vvwg_huang(27)=0.016644570076736
			vvwg_huang(28)=0.016644570076736
			vvwg_huang(29)=0.016644570076736
			vvwg_huang(30)=0.016644570076736
			vvwg_huang(31)=0.044326238118914
			vvwg_huang(32)=0.044326238118914
			vvwg_huang(33)=0.044326238118914
			vvwg_huang(34)=0.044326238118914
			vvwg_huang(35)=0.044326238118914
			vvwg_huang(36)=0.044326238118914
	...
	DO Kk=1,qp_triangle
		QUADRATURETRIANGLE_huang_weight(kk)=vvwg_huang(kk)
...
FUNCTION QUADRATURETRIANGLE_huang_POINT(N,IGQRULES)
	!> @brief
	!> This subroutine computes the quadrature points and weights for triangle in 2D
	IMPLICIT NONE
	INTEGER,INTENT(IN)::IGQRULES,N
	INTEGER::Kk
	REAL,dimension(2,qp_triangle)::QUADRATURETRIANGLE_huang_POINT
	REAL,dimension(36)::vvwg_huang,VVR1_huang,VVR2_huang,VVR3_huang
	WEQUA3D=0.0d0
	QPOINTS=0.0d0
	...
	DO Kk=1,qp_triangle
		...
		QUADRATURETRIANGLE_huang_POINT(:,kk)=(VVR1_huang(kk)*VEXT(1,:))+(VVR2_huang(kk)*VEXT(2,:))+(VVR3_huang(kk)*VEXT(3,:))
